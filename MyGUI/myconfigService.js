/*Implements access to the BLE configuration service of the OI.
The configuration is retrieved upon connecting to the OI and selectedIndex
is changed to reflect the current configuration. The OI encodes the
...
number from the OI when we read the configuration.
*/

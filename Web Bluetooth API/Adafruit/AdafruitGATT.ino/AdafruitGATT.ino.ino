...
//Publish values on BLE devices and get them display on the browser from laptop. 
//BLE uses GATT services : 
// GATT characteristics UV index 
...
void loop() {
  uvindexvalue = random(0, 11);  //randomly generate uv index
